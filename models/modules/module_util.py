...
def Upsample(dim, dim_out=None):#2H*2W
...
def Downsample(dim, dim_out=None):#HW减半
    return nn.Conv2d(dim, default(dim_out, dim), 4, 2, 1)


def default_conv(dim_in, dim_out, kernel_size=3, bias=False):#HW不变 无论卷积核多大
